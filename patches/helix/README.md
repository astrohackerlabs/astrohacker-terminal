...
- Selected upstream base commit:
  `4ed0899b0b0c3f7dadba550272cb300b871d8fa9`
- Upstream base subject:
  `fix: Skip applying on save changes to documents that have been closed`
...
- Issue archive: `patches/helix/patches/issue-0904`
- Current patch: `patches/issue-0904/0001-astrohacker-editor.patch`
...
Candidate results from Issue 904 Experiment 1:
...
```text
patches/helix/patches/issue-0904/0001-astrohacker-editor.patch
```
...
git -C /tmp/ahe-helix-gen switch -c issue-0904-astrohacker-editor
...
Apply to a clean checkout at the recorded base. Issue 904 Experiment 2 verified
...
git -C forks/helix switch -c issue-0904-astrohacker-editor
...
## Issue 904 Experiment 2 Evidence
...
- Patch generation: `logs/issue-904-exp2-patch-generation-fixed.log`
- Patch replay: `logs/issue-904-exp2-patch-replay-fixed.log`
- Release build: `logs/issue-904-exp2-ahe-release-build-fixed.log`
- Version/help/health checks:
  `logs/issue-904-exp2-ahe-version-fixed.log`,
  `logs/issue-904-exp2-ahe-help-fixed.log`,
  `logs/issue-904-exp2-ahe-health-rust-fixed.log`
- Source searches: `logs/issue-904-exp2-source-searches-fixed.log`
- Focused tests:
  `logs/issue-904-exp2-test-helix-loader-workspace-trust-fixed.log`,
  `logs/issue-904-exp2-test-helix-term-vim-profile-fixed.log`,
  `logs/issue-904-exp2-test-closed-doc-regression-fixed.log`
