...
- Temporary verification worktree:
  `/tmp/astrohacker-ghostty-issue-0013-verify`
...
Issue 900 regenerated the archive after moving Astrohacker Terminal-owned XDG
...
rm -rf /tmp/astrohacker-ghostty-issue-0013-verify
...
git -C forks/ghostty worktree remove /tmp/astrohacker-ghostty-issue-0013-verify --force
```
