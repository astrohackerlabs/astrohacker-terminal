...
VERSION="${TERMSURF_SMOKE_VERSION:-1.4.9}"
RUN_ID="$(date +%Y%m%d-%H%M%S)"
START_EPOCH="$(date +%s)"
LOG_DIR="$ROOT/logs/issue-871-exp1-installed-homebrew-cursor"
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Issue 871 Installed Cursor Fixture</title>
    <style>
      html,
      body {
        margin: 0;
  ...
  <body>
    ...
    <a id="link" href="https://example.com/">Issue 871 test link</a>
