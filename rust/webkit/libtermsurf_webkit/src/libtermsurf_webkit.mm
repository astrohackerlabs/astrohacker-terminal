...
static void tracePdfViewHierarchy(WebContents *contents, NSString *phase)
{
    ...
    appendPdfViewHierarchyTrace([NSString stringWithFormat:@"webkit-pdf-view-hierarchy-summary tab=%d phase=%@ pdf=1 visited_count=%lu pdf_document_source=%@ returns_pdf_document=%d page_count=%lu marker=issue-853-exp14",
        contents->tab_id,
        phase ?: @"unknown",
