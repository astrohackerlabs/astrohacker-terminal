...
clang \
  ...
  -Iinclude \
  -Ismoke-test \
  smoke-test/text_input_smoke.c \
  -Lbuild \
  -ltermsurf_webkit \
  -rpath "$PWD/build" \
  -rpath "$webkit_build" \
  -o build/text-input-smoke
...
clang \
  ...
  -Iinclude \
  -Ismoke-test \
  smoke-test/pointer_stream_smoke.c \
  -Lbuild \
  -ltermsurf_webkit \
  -rpath "$PWD/build" \
  -rpath "$webkit_build" \
  -o build/pointer-stream-smoke
...
clang \
  ...
  -Iinclude \
  -Ismoke-test \
  smoke-test/editing_round_trip_smoke.m \
  -Lbuild \
  -ltermsurf_webkit \
  -framework Cocoa \
  -rpath "$PWD/build" \
  -rpath "$webkit_build" \
  -o build/editing-round-trip-smoke
...
clang \
  ...
  -Iinclude \
  -Ismoke-test \
  smoke-test/navigation_lifecycle_smoke.m \
  -Lbuild \
  -ltermsurf_webkit \
  -framework Cocoa \
  -rpath "$PWD/build" \
  -rpath "$webkit_build" \
  -o build/navigation-lifecycle-smoke
...
clang \
  ...
  -Iinclude \
  -Ismoke-test \
  smoke-test/navigation_actions_smoke.m \
  -Lbuild \
  -ltermsurf_webkit \
  -framework Cocoa \
  -rpath "$PWD/build" \
  -rpath "$webkit_build" \
  -o build/navigation-actions-smoke

printf '%s\n' "built webkit/libtermsurf_webkit/build/libtermsurf_webkit.dylib"
printf '%s\n' "built webkit/libtermsurf_webkit/build/smoke-test"
printf '%s\n' "built webkit/libtermsurf_webkit/build/text-input-smoke"
printf '%s\n' "built webkit/libtermsurf_webkit/build/pointer-stream-smoke"
printf '%s\n' "built webkit/libtermsurf_webkit/build/editing-round-trip-smoke"
printf '%s\n' "built webkit/libtermsurf_webkit/build/navigation-lifecycle-smoke"
printf '%s\n' "built webkit/libtermsurf_webkit/build/navigation-actions-smoke"
