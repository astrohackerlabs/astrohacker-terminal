...
This control character is implemented in Astrohacker Terminal, although by default
...
terminator, Astrohacker Terminal will terminate any responses with the
`BEL` character.
