...
Astrohacker Terminal emulates a full 256-color palette, as well as 5 **special colors**
...
initialized, hence their name. Astrohacker Terminal supports three of these colors: the
...
Astrohacker Terminal supports platforms other than X11, it has its own color parser that
...
accepted color names are implementation-defined, but Astrohacker Terminal uses the
